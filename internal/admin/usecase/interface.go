...
type Usecase interface {
	...
	CreateTask(ctx context.Context, request models.TaskModel) (response models.CreateTaskResponse, err error)
	DeleteTask(ctx context.Context, request models.DeleteTaskRequest) (response models.DeleteTaskResponse, err error)
	GetUsersTaskList(ctx context.Context, filters models.TasksFilters) (tasks []models.TaskItem, err error)
}
